...
<title>OOPS Incorrect account</title>
</head>
<body>
...
<h2> It looks like you typed incorrect account details or the account doesn't exsist!</h2>
<h3>Try logging in again</h3>
					<form action="login">
					<ul class="horiz">
					<li class="horizl"><input type="text" name="Entlogin" placeholder="Enter Login">
					<li class="horizl"><input type="text" name="password" placeholder="Enter Password">
					<li class="horizl"><input type="submit" value="Go"/>
					</li>
					</ul>
					</form>
